...
package cn.xihan.lib.longan.design
...
inline fun TabLayout.addTab(list: List<String>, crossinline block: TabLayout.Tab.() -> Unit = {}) {
    list.forEach {
        addTab(it, block)
    }
}

inline fun TabLayout.addTab(list: Array<String>, crossinline block: TabLayout.Tab.() -> Unit = {}) {
    list.forEach {
        addTab(it, block)
    }
}

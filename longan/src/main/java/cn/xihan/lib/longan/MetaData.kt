...
fun applicationMetaDataOf(name: String): String? =
    application.packageManager.getApplicationInfo(packageName, GET_META_DATA).metaData.getString(
        name
    )
...
inline fun <reified T : Service> serviceMetaDataOf(name: String): String? =
    application.packageManager.getServiceInfo(ComponentName<T>(), GET_META_DATA).metaData.getString(
        name
    )
...
inline fun <reified T : BroadcastReceiver> receiverMetaDataOf(name: String): String? =
    application.packageManager.getReceiverInfo(
        ComponentName<T>(),
        GET_META_DATA
    ).metaData.getString(name)
